      ...
      subEvents: [
        ...
        },
        {
          ...
          <p>If you have a keen interest in the Indian parliamentary proceeding then this is an event where you can excel. </p>
                ...
                <h3>Round 1</h3>
                This is a constructive speech round participants will be given maximum of 2 minutes to speak 
                For the participant in group only 1 can speak.
                <h3>Round 2<h3>
                This a is a rebuttal round,anyone who is against the speaker can ask the question to the speaker and if the speaker fails to answer the question is opened to the house to be answered by anyone who is in favor of the speaker.
                The limitation of the time in cross questioning will be decided by the committee member according to the situation.
                <h3>Contact</h3>
