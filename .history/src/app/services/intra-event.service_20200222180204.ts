...
 
    ...
    {
      id: "ciic",
      desc: `<h1>BUSINESS MODEL PLAN- Your Opportunity to Disrupt</h1>
            <p>Rules-

            1. The competition is open for teams comprising of undergraduate and postgraduate students.
    
            2. Team can consist of a maximum of 3 members. Only one of the team member should register as Team Leader.
    
            3. A participant can also apply individually.
    
            4. More than 1 team can participate from a college.
    
            5. One participant cannot be a part of more than one team.
    
            6. No change of team structure is permitted after the team is registered.
    
            7. A team can submit more than one business plan/idea after registration but in doing so, it must register separately for each submission. The same email-id and/or team name cannot be used for doing so.
            8. Competition timeline-
    
    Round 1- Online:
                I. Register at - 
                II. The teams must apply with their pitch deck.
                III. After Result declaration – Submission of Business Model Canvas
    
    Round 2 - Offline:
                    I. Pitch Right - Best start-ups idea will be selected to pitch their ideas in a 180-second elevator ride; to win an investor's heart, you have to get your own "elevator pitch" ready.
                    II. Ultimate B-Model - The format and other details about the oral presentation will be conveyed later.
            9. The judges will evaluate the presentations based on the following CRITERIA:
                I. Background Study.
                II. Originality in the research work.
                III. Volume of the work carried out.
                IV. Novelty in thinking.
    
    Contacts:
    Sumit: 9572683975
    Sougata: 8250218868</p>
